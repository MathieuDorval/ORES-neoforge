...
public class OreList {
    public static final List<OreDefinition> ORES = Collections.unmodifiableList(Arrays.asList(
            ...
            new OreDefinition("silver",   2, 30,  true,  "ingot", 1, 1, "raw")     // Autre exemple de nouveau minerai (raw)
    ));
